 ...
 */
public class StairClickAdapterTest {
    @Test
    public void onlyTest(){
        IController controller = Mockito.mock(IController.class);
        View view = Mockito.mock(View.class);
        View.OnClickListener adapter = new StairClickAdapter(controller);
        adapter.onClick(view);
        Mockito.verify(controller).useStairs(false);
        adapter.onClick(view);
        Mockito.verify(controller).useStairs(true);
    }
}
